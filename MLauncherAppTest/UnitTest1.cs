...
namespace MLauncherAppTest
{
    public class UnitTest1
    {
        ...
        public void リストに存在しない名前を検索した時_存在しませんとエラーメッセージが出る()
        {
            ...
            var vm = new MainWindowViewModel(serviceMoc.Object, runnerServiceMoc.Object);
        ...
        public void スラッシュlistで全登録済パスを記録したテキストファイルを開く()
        {
            ...
            var vm = new MainWindowViewModel(messageServiceMoc.Object, runnerServiceMoc.Object);
